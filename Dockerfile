...
ENV QMODES_SUPPRESS_NEW_USER_WARNINGS="False"
ENV QMODES_get_QMODES_TEST_DIR="QMODES_BASE_DIR/qMODES/tests"
ENV QMODES_get_QMODES_TESTDATA_DIR="$QMODES_TEST_DIR/test_data"
