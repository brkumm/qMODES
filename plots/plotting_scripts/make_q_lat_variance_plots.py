#--------------------------------------------------------------------------
# IMPORTS
from qMODES import read_ERA_grid_data
from qMODES import get_single_plev_ERA_and_flipped_qmodes_data, get_single_plev_ERA_and_flipped_qmodes_data_with_p_and_lat_dependent_background
...
plev_list = [95 - 19*i for i in range(2)] #list of plev indices to generate plots for
#--------------------------------------------------------------------------
...
for iplev in range(len(plev_list)):
    ...
    [qERA,qEIG,qWIG,qROT,qM] = get_single_plev_ERA_and_flipped_qmodes_data_with_p_and_lat_dependent_background(ERA_datafile, qMODES_datafile, plev_list[iplev])
...
#--------------------------------------------------------------------------
# SAVING PLOTS
outputfile1 = f"{get_QMODES_PLOTS_DIR()}/q_lat_variance_{date}.pdf"
outputfile2 = f"{get_QMODES_PLOTS_DIR()}/q_lat_variance_{date}.jpeg"

plt.savefig(outputfile1)
plt.savefig(outputfile2)

print(f"q lat variance plots saved to:\n\t{outputfile1}\n\t{outputfile2}\n")
#--------------------------------------------------------------------------